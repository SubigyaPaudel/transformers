...
# NLP lab course inputs (Paudel, Panthi, Chhetri)
from BidirectionalUtils import supress_causal_masks
# 
    ...
    def forward(
        ...
        if self.force_bidirectional:
            ...
            if causal_mask is None:
                is_causal = False
            elif causal_mask.shape[3] == causal_mask.shape[2]:
                # ensure that the causal_mask is 2D per head
                causal_mask = supress_causal_masks(causal_mask)
